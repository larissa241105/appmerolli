...
const QrcodeScreenAntigo = () => {
    ...
    const handleScanQrcode = () => {
        router.push({
            pathname: 'biparqrcodeScreenAntigo',
            params: params 
        });
    };

    const handleSearchPlaqueta = () => {
        if (!plaquetaAntigaValue.trim()) {
            ...
            >
                ...
                <View style={styles.contentContainer}>
                    <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                    >
                        <Text style={styles.qrButtonTitle}>Bipar QR Code Antigo do Cliente</Text>
                        <Image
                    ...
                    <View style={styles.inputSection}>
                        ...
                        <TextInput
                            ...
                            maxLength={10} 
                            value={plaquetaAntigaValue}
                            onChangeText={setplaquetaAntigaValue} 
                        />
...
export default QrcodeScreenAntigo;